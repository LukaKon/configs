    ...
    widgets_list = [
        ...
        widget.TextBox(
            ...
            mouse_callbacks={'Button1': lambda qtile: qtile.cmd_spawn(
                'geany /home/steve/.config/qtile/config.py')},
            padding=2,
            fontsize=12
        ),
        widget.Sep(
        ...
        widget.TextBox(
            ...
            background=colors[1],
            mouse_callbacks={
                'Button1': lambda qtile: qtile.cmd_spawn(myTerm + ' -e gtop')},
            padding=2,
            fontsize=12
        ),
        widget.CPU(
        ...
        widget.TextBox(
            ...
            background=colors[1],
            mouse_callbacks={
                'Button1': lambda qtile: qtile.cmd_spawn('xdiskusage')},
            padding=0,
            fontsize=12
        ),
        widget.GenPollText(
            ...
            func=lambda: subprocess.check_output(
                "/home/steve/dwmscripts/qtiledisk").decode("utf-8").replace('\n', ''),
            foreground=colors[5],
            background=colors[1]
        ),
        widget.Sep(
        ...
        widget.TextBox(
            ...
            background=colors[1],
            mouse_callbacks={
                'Button1': lambda qtile: qtile.cmd_spawn('pamac-manager')},
            padding=0,
            fontsize=12
        ),
        widget.GenPollText(
            ...
            fontsize=14,
            func=lambda: subprocess.check_output(
                "/home/steve/dwmscripts/qtileupdates").decode("utf-8").replace('\n', ''),
            foreground=colors[5],
            background=colors[1]
        ),
        widget.Sep(
